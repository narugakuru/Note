...
```shell
curl.exe -u hltest01:hltest01 -I http://153.120.83.98/report/new/all/pdf/fy05_04_09_01.pdf;

$username = "hltest01"; $password = ConvertTo-SecureString "hltest01" -AsPlainText -Force; $credential = New-Object System.Management.Automation.PSCredential($username, $password); Invoke-WebRequest -Uri http://153.120.83.98/report/new/all/pdf/fy05_04_09_01.pdf -Credential $credential -Method Head

# Define the base URL and credentials
$baseUrl = "http://153.120.83.98"
$username = "hltest01"
$password = "hltest01"

# Define the array of URL paths
$paths = @(
    "/report/new/all/pdf/fy05_04_09_01.pdf",
    "/report/new/all/pdf/fy05_04_09_02.pdf",
)

# Loop through the paths and execute the curl command for each URL
foreach ($path in $paths) {
    $url = "$baseUrl$path"
    Write-Output "Processing URL: $url"
    & curl.exe -u "${username}:${password}" -I $url
}
