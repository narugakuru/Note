...
Options:
  ...
  Control the inclusion of modules and packages in result:
    ...
    --prefer-source-code
                        ...
                        best performance. If not desired, there is --noprefer-source-code to disable warnings about it.
                        Default off.
  ...
  Cache Control:
    --disable-cache=DISABLED_CACHES
                        ...
                        "all","ccache","bytecode","compression","dlldependencies". can be given multiple times or with
    ...
    --disable-ccache    Do not attempt to use ccache (gcc, clang, etc.) or
                        clcache (MSVC, clangcl). Same as --disablecache=ccache.
    --disable-dll-dependency-cache
                        ...
                        cause errors. Same as --disable-cache=dlldependencies.
  ...
  Plugin control:
    ...
    --module-parameter=MODULE_PARAMETERS
                        ...
                        currently --module-parameter=module.name-optionname=value Default empty.
