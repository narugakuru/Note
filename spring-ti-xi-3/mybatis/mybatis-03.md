...
![image-20210224155400455](D:%5C%E5%B7%A5%E4%BD%9C%5C%E4%B8%AA%E4%BA%BA%E8%84%91%E5%9B%BE%5C%E8%AF%BE%E7%A8%8B%5C%E8%AF%BE%E7%A8%8B%E8%B5%84%E6%96%99%5C%E8%AE%B2%E4%B9%89%5CSSM%5CMybatis%5Cimg%5Cimage-2.png)
...
![image-20210224164927461](../../Spring%E4%BD%93%E7%B3%BB/Mybatis/img/image-4.png)
...
![image-20210224170108202](../../Spring%E4%BD%93%E7%B3%BB/Mybatis/img/image-5.png)
...
几种不会使用一级缓存的情况 1.调用相同方法但是传入的参数不同 2.调用相同方法参数也相同，但是使用的是另外一个SqlSession 3.如果查询完后，对同一个表进行了增，删改的操作，都会清空这sqlSession上的缓存 4.如果手动调用SqlSession的clearCache方法清除缓存了，后面也使用不了缓存
